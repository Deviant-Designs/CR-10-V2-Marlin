...
#define BABYSTEPPING
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  //GI

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  //GI
 ...
 */
  ...
  //#define STEALTHCHOP_E  //GI disabled
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V  //GI
